...
def update_expense(expense_id: int, date: str = None, amount: float = None, category: str = None, subcategory: str = None, note: str = None):
    '''Update an existing expense entry by ID. Only provided fields are updated.'''
...
def server_info():
    ...
    info={
        "name":"SpendsEyes",
        "version": "1.0.0",
        "description":"Basic server for tracking your daily needs",
        "tools":["add_expense", "update_expense", "delete_expense", "list_expenses", "summarize" ],
        "author":"JOKER"
    }
